...
function Hex_To_Byte(Hex_Pair:Hex_Pair_Type) return Byte is
   ...
   Number:Byte;
   Hex_String:String:=Character_To_String(Hex_Pair(1)) & Character_To_String(Hex_Pair(2));
   My_String:String:="16#" & Hex_String & "#";
...
function Character_To_String(My_Character:Character) return String is
   ...
   My_String:String:=Character'Image(My_Character);
   My_String_Strip:String:=My_String(My_String'First + 1 .. My_String'Last - 1);
...
function Get_Random_Byte return Byte is
   ...
   Range_Begin:Positive:=Byte_To_Integer(Byte'First);
   Range_End:Positive:=Byte_To_Integer(Byte'Last);

   Random_Byte:Byte:=Integer_To_Byte(Random.Random(Range_Begin, Range_End));
