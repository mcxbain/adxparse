...
begin
   ...
   Append(My_String, "-d --directory   Parse Directory      parse -d /home/tux/mydir/ -c adxlib" & ASCII.LF);
   Append(My_String, "-f --file        Parse File           parse -f /home/tux/myfile.ads" & ASCII.LF);
